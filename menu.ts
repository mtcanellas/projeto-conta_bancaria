...
function criarConta(){
    ...
    switch(tipo){
        ...
        case 2: // Cria um objeto da classe Conta Poupança
            ...
            const niver = Input.questionInt("");
            contas.cadastrar(new ContaPoupanca(
                contas.gerarNumero(), agencia, titular, tipo, saldo, niver));
        break;
    ...
    if (conta !== null) {
        ...
        switch(tipo){
            case 1: // Conta Corrente
                 ...
                 * O mesmo será feito com o atributo niver da classe
                 * ContPoupanca
                 */
            ...
            case 2: // Conta Poupança
                ...
                let niver:  number =   (conta as ContaPoupanca).niver;

                // Atualização do Aniversário
                console.log(`\nAniversário Atual: ${niver}`);
                console.log("Digite o novo dia do aniversário: ");
                console.log("(Pressione ENTER para manter o valor atual)");
                niver = Input.questionInt("", { defaultInput: niver });

                contas.atualizar(new ContaPoupanca(numero, agencia, titular, tipo, saldo, niver));
